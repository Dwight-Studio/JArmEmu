...
public class LongImmediateOrRegisterArgument extends OptionalLongImmediateOrRegisterArgument {

    public LongImmediateOrRegisterArgument(String originalString) throws SyntaxASMException {
