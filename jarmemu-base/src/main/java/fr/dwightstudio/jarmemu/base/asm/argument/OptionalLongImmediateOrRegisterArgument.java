...
public class OptionalLongImmediateOrRegisterArgument extends ParsedArgument<RegisterOrImmediate> implements OptionalRegister {

    private boolean immediate;
    private LongImmediateArgument immediateArgument;
    private RegisterArgument registerArgument;

    public OptionalLongImmediateOrRegisterArgument(String originalString) throws SyntaxASMException {
