...
public class LSLInstruction extends ParsedInstruction<Register, Register, ImmediateOrRegisterArgument.RegisterOrImmediate, Object> {
    public LSLInstruction(Modifier modifier, String arg1, String arg2, String arg3, String arg4) throws ASMException {
        super(modifier,  arg1, arg2, arg3, arg4);
    }

    public LSLInstruction(Modifier modifier, ParsedArgument<Register> arg1, ParsedArgument<Register> arg2, ParsedArgument<ImmediateOrRegisterArgument.RegisterOrImmediate> arg3, ParsedArgument<Object> arg4) {
        super(modifier,  arg1, arg2, arg3, arg4);
    }
    ...
    protected void execute(StateContainer stateContainer, boolean ignoreExceptions, Register arg1, Register arg2, ImmediateOrRegisterArgument.RegisterOrImmediate arg3, Object arg4) throws ExecutionASMException {
        ...
        if (modifier.doUpdateFlags()) {
            ...
            stateContainer.getCPSR().setC((oldValue & (1 << (32 - arg3.intValue()))) != 0);
        }
    }
