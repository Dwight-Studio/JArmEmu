...
public class LSRInstruction extends ParsedInstruction<Register, Register, RegisterOrImmediate, Object> {
    ...
    public int getMemoryCode(StateContainer stateContainer, int pos) {
        return InstructionCodeUtils.getShift(stateContainer, this, Shift.LSR);
    }
    ...
    protected void verify(StateContainer stateContainer, Register arg1, Register arg2, RegisterOrImmediate arg3, Object arg4) throws SyntaxASMException {
        if (arg3.intValue() < 1 || arg3.intValue() > 32)
            throw new SyntaxASMException(JArmEmuApplication.formatMessage("%exception.argument.shift1to32", this.arg3.getOriginalString()));
    }
}
