...
class SUBInstructionTest extends InstructionTest<Register, Register, ImmediateOrRegisterArgument.RegisterOrImmediate, ShiftArgument.ShiftFunction> {
    SUBInstructionTest() {
        super(SUBInstruction.class);
    }

    @Test
    public void simpleSubTest() throws ASMException {
        ...
        r1.setData(1);
        legacyExecute(stateContainerBis, false, false, null, null, r2, r0, new ImmediateOrRegisterArgument.RegisterOrImmediate(r1), shift());
    ...
    public void flagsTest() throws ASMException {
        ...
        r0.setData(0b10000000000000000000000000000000);
        r1.setData(1);
        legacyExecute(stateContainer, false, true, null, null, r2, r0, new ImmediateOrRegisterArgument.RegisterOrImmediate(r1), shift());
