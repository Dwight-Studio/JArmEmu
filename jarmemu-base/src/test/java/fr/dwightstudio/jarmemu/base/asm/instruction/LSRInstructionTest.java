...
class LSRInstructionTest extends InstructionTest<Register, Register, RegisterOrImmediate, Object> {
    LSRInstructionTest() {
    ...
    public void flagsTest() throws ASMException {
        ...
        r0.setData(-25);
        r1.setData(25);
        legacyExecute(stateContainer, false, true, null, null, r1, r1, new RegisterOrImmediate(3), null);
