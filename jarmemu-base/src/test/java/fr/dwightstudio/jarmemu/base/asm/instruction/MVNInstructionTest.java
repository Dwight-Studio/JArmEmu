...
class MVNInstructionTest extends InstructionTest<Register, Integer, ShiftArgument.ShiftFunction, Object> {
    ...
    public void simpleMvnTest() throws ASMException {
        ...
        legacyExecute(stateContainer, false, false, null, null, r0, Integer.MIN_VALUE, shift(), null);
        ...
        legacyExecute(stateContainer, false, false, null, null, r2, 0b10101010101010101010010001000001, shift(), null);
