...
class RSBInstructionTest extends InstructionTest<Register, Register, RegisterOrImmediate, ShiftFunction> {
    RSBInstructionTest() {
    ...
    public void simpleRsbTest() throws ASMException {
        ...
        legacyExecute(stateContainerBis, false, false, null, null, r2, r0, new RegisterOrImmediate(r1, false), shift());
    ...
    public void flagsTest() throws ASMException {
        ...
        r0.setData(1);
        r1.setData(0b10000000000000000000000000000000);
        legacyExecute(stateContainer, false, true, null, null, r2, r0, new RegisterOrImmediate(r1, false), shift());
