...
public class ANDInstructionTest extends InstructionTest<Register, Register, ImmediateOrRegisterArgument.RegisterOrImmediate, ShiftArgument.ShiftFunction> {
    protected ANDInstructionTest() {
        super(ANDInstruction.class);
    }

    @Test
    public void simpleAndTest() throws ASMException {
        stateContainer.getRegister(0).setData(0b00000000000000000000000000101011);
