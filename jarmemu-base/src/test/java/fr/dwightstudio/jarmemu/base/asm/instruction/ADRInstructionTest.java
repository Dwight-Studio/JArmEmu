...
public class ADRInstructionTest extends InstructionTest<Register, Integer, Object, Object> {
    public ADRInstructionTest() {
        super(ADRInstruction.class);
    }

    @Test
    public void simpleAdrTest() throws ASMException {
