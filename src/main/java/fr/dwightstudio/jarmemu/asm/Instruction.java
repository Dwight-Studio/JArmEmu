...
public enum Instruction {
    ...
    // Arithmetic
    ADD(ADD_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    SUB(SUB_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    RSB(RSB_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    ADC(ADC_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    SBC(SBC_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    RSC(RSC_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    ...
    // Bitwise logic
    AND(AND_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    ORR(ORR_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    EOR(EOR_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),
    BIC(BIC_EXECUTOR, REGISTER, REGISTER, VALUE_OR_REGISTER, NULL),

    // Comparison
    CMP(CMP_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),
    CMN(CMN_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),
    TST(TST_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),
    TEQ(TEQ_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),

    // Data movement
    MOV(MOV_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),
    MVN(MVN_EXECUTOR, REGISTER, VALUE_OR_REGISTER, NULL, NULL),

    // Memory access
    LDR(LDR_EXECUTOR, REGISTER, ADDRESS, NULL, NULL),
    STR(STR_EXECUTOR, REGISTER, ADDRESS, NULL, NULL),
    LDM(LDM_EXECUTOR, REGISTER, REGISTER_ARRAY, NULL, NULL),
    STM(STM_EXECUTOR, REGISTER, REGISTER_ARRAY, NULL, NULL),
