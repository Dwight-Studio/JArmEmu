...
public enum Instruction {
    ...
    // Arithmetic
    ADD(ADD_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    SUB(SUB_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    RSB(RSB_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    ADC(ADC_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    SBC(SBC_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    RSC(RSC_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    MUL(MUL_EXECUTOR, true, REGISTER, REGISTER, REGISTER, NULL),
    MLA(MLA_EXECUTOR, false, REGISTER, REGISTER, REGISTER, NULL),
    MLS(MLS_EXECUTOR, false, REGISTER, REGISTER, REGISTER, NULL),
    ...
    // Bitwise logic
    AND(AND_EXECUTOR, true, REGISTER, REGISTER, VALUE_8_OR_REGISTER, SHIFT),
    ...
    CMN(CMN_EXECUTOR, false, REGISTER, VALUE_8_OR_REGISTER, SHIFT, NULL),
    TST(TST_EXECUTOR, false, REGISTER, VALUE_8_OR_REGISTER, SHIFT, NULL),
    TEQ(TEQ_EXECUTOR, false, REGISTER, VALUE_8_OR_REGISTER, SHIFT, NULL),

    // Data movement
    MOV(MOV_EXECUTOR, false, REGISTER, VALUE_8_OR_REGISTER, SHIFT, NULL),
    MVN(MVN_EXECUTOR, false, REGISTER, VALUE_8_OR_REGISTER, SHIFT, NULL),

    // Memory access
    LDR(LDR_EXECUTOR, false, REGISTER, ADDRESS, VALUE_8_OR_REGISTER, SHIFT),
    STR(STR_EXECUTOR, false, REGISTER, ADDRESS, VALUE_8_OR_REGISTER, SHIFT),
    ...
    SWI(SWI_EXECUTOR, false, LABEL, NULL, NULL, NULL);
