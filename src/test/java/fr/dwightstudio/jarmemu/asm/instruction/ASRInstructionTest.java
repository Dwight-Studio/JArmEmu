...
public class ASRInstructionTest extends InstructionTest<Register, Register, Integer, Object> {
    ...
    public void flagsTest() throws ASMException {
        ...
        r1.setData(-25);
        r2.setData(-25);
        execute(stateContainer, false, true, null, null, r2, r2, 1, null);
        ...
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r0, r0, 3, null);
        assertEquals(3, r0.getData());
        assertFalse(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertFalse(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r1, r1, 4, null);
        assertEquals(-2, r1.getData());
        assertTrue(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertFalse(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r1, r1, 27, null);
        assertEquals(-1, r1.getData());
        assertTrue(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r1, r1, 1, null);
        assertEquals(-1, r1.getData());
        assertTrue(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        r1.setData(Integer.MAX_VALUE);
        execute(stateContainer, false, true, null, null, r0, r1, 1, null);
        assertEquals(1073741823, r0.getData());
        assertFalse(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r0, r1, 2, null);
        assertEquals(536870911, r0.getData());
        assertFalse(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r0, r1, 3, null);
        assertEquals(268435455, r0.getData());
        assertFalse(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r0, r1, 4, null);
        assertEquals(134217727, r0.getData());
        assertFalse(stateContainer.getCPSR().getN());
        assertFalse(stateContainer.getCPSR().getZ());
        assertTrue(stateContainer.getCPSR().getC());
        execute(stateContainer, false, true, null, null, r0, r1, 31, null);
