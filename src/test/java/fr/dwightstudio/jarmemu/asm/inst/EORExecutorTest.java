...
public class EORExecutorTest {
    ...
    public void simpleEorTest() {
        ...
        eorExecutor.execute(stateContainerBis, false, null, null, r0, r1, r2.getData(), ArgumentParsers.SHIFT.none());
    ...
    public void flagsTest() {
        ...
        eorExecutor.execute(stateContainer, true, null, null, r2, r1, r0.getData(), ArgumentParsers.SHIFT.none());
