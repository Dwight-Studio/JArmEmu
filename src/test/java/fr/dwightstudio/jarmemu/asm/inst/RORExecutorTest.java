...
public class RORExecutorTest extends JArmEmuTest {
    ...
    public void simpleRorTest() {
        ...
        r0.setData(25);
        r1.setData(-25);
        rorExecutor.execute(stateContainer, false, null, null, r0, r0, 3, null);
        assertEquals(536870915, r0.getData());
        rorExecutor.execute(stateContainer, false, null, null, r1, r1, 4, null);
        assertEquals(2147483646, r1.getData());
        rorExecutor.execute(stateContainer, false, null, null, r1, r1, 27, null);
        assertEquals(-49, r1.getData());
        rorExecutor.execute(stateContainer, false, null, null, r1, r1, 1, null);
    ...
    public void flagsTest() {
        ...
        r0.setData(-25);
        r1.setData(25);
        rorExecutor.execute(stateContainer, true, null, null, r1, r1, 3, null);
        ...
        rorExecutor.execute(stateContainer, true, null, null, r0, r0, 4, null);
        assertEquals(2147483646, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertFalse(stateContainer.cpsr.getC());
        rorExecutor.execute(stateContainer, true, null, null, r0, r0, 27, null);
        assertEquals(-49, r0.getData());
        assertTrue(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        rorExecutor.execute(stateContainer, true, null, null, r0, r0, 1, null);
