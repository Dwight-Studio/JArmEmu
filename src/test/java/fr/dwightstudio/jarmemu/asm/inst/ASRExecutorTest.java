...
public class ASRExecutorTest extends JArmEmuTest {
    ...
    public void flagsTest() {
        ...
        asrExecutor.execute(stateContainer, true, null, null, r0, r1, 1, null);
        assertEquals(1073741823, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        asrExecutor.execute(stateContainer, true, null, null, r0, r1, 2, null);
        assertEquals(536870911, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        asrExecutor.execute(stateContainer, true, null, null, r0, r1, 3, null);
        assertEquals(268435455, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        asrExecutor.execute(stateContainer, true, null, null, r0, r1, 4, null);
        assertEquals(134217727, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        asrExecutor.execute(stateContainer, true, null, null, r0, r1, 31, null);
