...
public class LSRExecutorTest extends JArmEmuTest {
    ...
    public void simpleLsrTest() {
        ...
        r0.setData(25);
        r1.setData(-25);
        lsrExecutor.execute(stateContainer, false, null, null, r0, r0, 3, null);
        assertEquals(3, r0.getData());
        lsrExecutor.execute(stateContainer, false, null, null, r1, r1, 4, null);
        assertEquals(268435454, r1.getData());
        lsrExecutor.execute(stateContainer, false, null, null, r1, r1, 27, null);
        assertEquals(1, r1.getData());
        lsrExecutor.execute(stateContainer, false, null, null, r1, r1, 1, null);
    ...
    public void flagsTest() {
        ...
        r0.setData(-25);
        r1.setData(25);
        lsrExecutor.execute(stateContainer, true, null, null, r1, r1, 3, null);
        ...
        lsrExecutor.execute(stateContainer, true, null, null, r0, r0, 4, null);
        assertEquals(268435454, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertFalse(stateContainer.cpsr.getC());
        lsrExecutor.execute(stateContainer, true, null, null, r0, r0, 27, null);
        assertEquals(1, r0.getData());
        assertFalse(stateContainer.cpsr.getN());
        assertFalse(stateContainer.cpsr.getZ());
        assertTrue(stateContainer.cpsr.getC());
        lsrExecutor.execute(stateContainer, true, null, null, r0, r0, 1, null);
