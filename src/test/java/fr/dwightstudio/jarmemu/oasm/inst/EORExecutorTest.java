...
public class EORExecutorTest extends JArmEmuTest {
    ...
    public void simpleEorTest() {
        ...
        eorExecutor.execute(stateContainerBis, false, false, null, null, r0, r1, r2.getData(), shift());
    ...
    public void flagsTest() {
        ...
        eorExecutor.execute(stateContainer, false, true, null, null, r2, r1, r0.getData(), shift());
