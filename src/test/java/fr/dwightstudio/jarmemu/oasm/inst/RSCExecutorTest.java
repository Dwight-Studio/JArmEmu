...
public class RSCExecutorTest extends JArmEmuTest {
    ...
    public void simpleRscTest() {
        ...
        r2.setData(5);
        rscExecutor.execute(stateContainerBis, false, false, null, null, r0, r1, r2.getData(), shift());
    ...
    public void flagsTest() {
        ...
        rscExecutor.execute(stateContainer, false, true, null, null, r2, r0, r1.getData(), shift());
