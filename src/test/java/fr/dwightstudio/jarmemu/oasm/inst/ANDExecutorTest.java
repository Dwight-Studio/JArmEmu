...
public class ANDExecutorTest extends JArmEmuTest {
    ...
    public void simpleAndTest() {
        ...
        andExecutor.execute(stateContainerBis, false, false, null, null, r0, r1, r2.getData(), shift());
    ...
    public void flagsTest() {
        ...
        andExecutor.execute(stateContainer, false, true, null, null, r2, r1, r0.getData(), shift());
