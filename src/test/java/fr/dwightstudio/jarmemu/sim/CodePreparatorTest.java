...
public class CodePreparatorTest {
    ...
    public void convertMovToShiftTest() {
        ...
        instr.put(0, add);
        codePreparator.parsedObjects = new TreeMap<>();
        codePreparator.parsedObjects.put(0, add);
        codePreparator.replaceMovShifts(stateContainer);
        assertEquals(instr, codePreparator.parsedObjects);
        ParsedInstruction mov = new ParsedInstruction(Instruction.MOV, Condition.EQ, true, null, null, "r1", "r0", null, null);
        instr.put(1, mov);
        codePreparator.parsedObjects.put(1, mov);
        codePreparator.replaceMovShifts(stateContainer);
        assertEquals(instr, codePreparator.parsedObjects);
        ...
        instr.put(2, Shift);
        codePreparator.parsedObjects.put(2, movShift);
        codePreparator.replaceMovShifts(stateContainer);
        assertEquals(instr, codePreparator.parsedObjects);
    }
