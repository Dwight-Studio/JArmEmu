...
JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is a simple, user-friendly simulator that provides basic control and information about a simulated ARMv7
architecture.

JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is powered by an ARMv7 interpreter built *Ex Nihilo* for this project, which provides real-time syntax
...
You can compile and run JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> directly from source by cloning this repository. The project requires the `JDK 21` and
...
To launch JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/>, you juste need to `compile` and run the maven goal `exec:java` :
```bash
mvn compile exec:java
```
## Portable

JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is distributed in a portable archive available from
...
You can download an installer for JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> (or the portable version) from
...
JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is also available on Chocolatey:
...
JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is available on [FlatHub](https://flathub.org/fr/apps/fr.dwightstudio.JArmEmu).
...
JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is available on [Fedora Copr](https://copr.fedorainfracloud.org/coprs/dwight-studio/JArmEmu/package/jarmemu/):
...
JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is available on [AUR](https://aur.archlinux.org/packages/jarmemu). Use your favorite AUR Helper (`yay` for
instance):
...
(not affiliated). JArmEmu <img src="https://static.dwightstudio.fr/jarmemu/LOGO_MONO.svg" alt="drawing" width="18"/> is distributed in open source under GPL3 (refer to the LICENCE file).
