...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is a simple, user-friendly simulator that provides basic control and information about a simulated ARMv7
architecture.

<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is powered by an ARMv7 interpreter built *Ex Nihilo* for this project, which provides real-time syntax
...
You can compile and run <img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu directly from source by cloning this repository. The project requires the `JDK 21` and
...
To launch <img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu, you juste need to `compile` and run the maven goal `exec:java` :
```bash
mvn compile exec:java
```
## Portable

<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is distributed in a portable archive available from
...
You can download an installer for <img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu (or the portable version) from
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is also available on Chocolatey:
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is available on [FlatHub](https://flathub.org/fr/apps/fr.dwightstudio.JArmEmu).
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is available on [Fedora Copr](https://copr.fedorainfracloud.org/coprs/dwight-studio/JArmEmu/package/jarmemu/):
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is available on [AUR](https://aur.archlinux.org/packages/jarmemu). Use your favorite AUR Helper (`yay` for
instance):
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is available on the Dwight Studio repository.
...
<img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is available with the [Nix](https://nixos.org/) package manager through this repository flake.
...
This project is managed by the <img src="https://static.dwightstudio.fr/v1/dwightstudio/base/svg/logo_white.svg" alt="drawing" width="15"/> Dwight Studio collective, which is not affiliated not endorsed by Arm Limited in any sort.

This project was created by Kévin "FoxYinx" TOLLEMER and Alexandre "Deleranax" LECONTE, students at INSA Rennes
(not affiliated). <img src="https://static.dwightstudio.fr/v1/jarmemu/base/svg/logo_mono.svg" alt="drawing" width="15"/> JArmEmu is distributed in open source under GPL3 (refer to the LICENCE file).
